# Any class definitions required for student code. Must be imported by both
# the preprocessor and student code to allow serializing the execution results.

# Example: MITCampus dependencies
